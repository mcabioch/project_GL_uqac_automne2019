...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Planning Generator: A software to generate some plannings according to specifications.</title>
...
<div class="title">A software to generate some plannings according to specifications. </div>  </div>
</div><!--header-->
<div class="contents">
...
<li class="level1"><a href="#imp_sec">Important features</a><ul><li class="level2"><a href="#imp_sec_obj_subsec">Objects</a></li>
...
<div class="textblock"><dl class="section date"><dt>Date</dt><dd>Created : Thursday October, 17 2019 10:53:05 </dd>
<dd>
Last modification on <?php echo $lastModif; ?> </dd></dl>
<dl class="section author"><dt>Author</dt><dd>Mathias CABIOCH-DELALANDE </dd></dl>
<dl class="section copyright"><dt>Copyright</dt><dd><hr/>
</dd></dl>
