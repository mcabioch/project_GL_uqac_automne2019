...
public class TeamMemberController {
	...
	@PatchMapping("/teamMember/{id}/edit")
	public ResponseEntity<Object> editTeamMember(@RequestBody String body, @PathVariable String id) {
		...
		TeamMember dbTm = getTeamMemberByUserId(id);
		
		if(teamMemberJson.has("nbHeures")) dbTm.setNbHeures(teamMemberJson.getInt("nbHeures"));
		if(teamMemberJson.has("nonTravail")) dbTm.setJourDeRepos(teamMemberJson.getString("nonTravail"));
		
		teamMemberRepository.save(dbTm);
		
		return new ResponseEntity<>("Team member edited", HttpStatus.OK);
	}
